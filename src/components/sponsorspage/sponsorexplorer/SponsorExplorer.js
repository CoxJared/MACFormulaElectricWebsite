    ...
    this.state = {
      platinum: [
        ...
        color:"rgb(166,151,106)"},
          ...
          {id: 2,
              ...
              img: DspaceLogo,
              description:"dSPACE’s leading software and hardware-based simulations ensure a vehicle’s drive system is energy-efficient, the intelligent assistance systems make driving more comfortable, and that the plane they are on is safely guided to its destination. dSPACE is working with leading technology providers to make the vision of autonomous driving a reality.",
              color:"rgb(22,70,145)"},
          {id: 0,
              name: 'General Motors',
      ...
      gold: [
          ...
          {id: 7,
              ...
              description:"McLaren Engineering Group provides innovative engineering solutions to ten technical divisions include Site/Civil, Geotechnical, Marine, Bridge/Highway/Rail, Surveying, Forensics, Entertainment, Structural, Facade Engineering, and Construction Engineering. Ranging from high-rise structures and entertainment venues to bridges and piers, McLaren Engineering Group offers unparalleled service using Applied Ingenuity.",
              color:"rgb(178,87,52)"},
              ,
          {id: 8,
              name: 'MES',
          ...
          {id: 10,
              ...
              img: TeLogo,
              description:"TE Connectivity partners with customers to produce highly engineered connectivity and sensing products that make a connected world possible. Specialized for harsh environments in a variety of industries, such as automotive, industrial equipment, data communication systems, aerospace, defense, medical, oil and gas, consumer electronics and energy, TE Connectivity enables companies to turn ideas into technology.",
