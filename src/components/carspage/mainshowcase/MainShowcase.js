  ...
  render() {
    window.onscroll = function() {
      ...
      try{
        ...
        //move description up
        document.getElementById("text-container").style.height=(currentScrollPos + 500 + "px");
        ...
        document.getElementById("main-specs").style.opacity=( (currentScrollPos-delay)/7 + "%");
        ...
        if (currentScrollPos > 1150) {
          ...
          document.getElementById("main-showcase-container").style.top ="1150px";
        }
        else{
      ...
      <div id="main-showcase-container">
        ...
        <div id="main-specs">
          ...
          <div id="spec">
            ...
            <h2 className="spec-value">220kg<span>/400lb</span></h2>
          </div>
          <div id="spec">
